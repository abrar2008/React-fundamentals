...
class App extends Component {
  render() {
           ...
           chart.map(rec =>{
             return(
               (!bookLikedBy[rec.bookLikedID])
               ?bookLikedBy[rec.bookLikedID] =[rec.peepsID]
               :bookLikedBy[rec.bookLikedID].push(rec.peepsID)
    ...
    return (
      <div>
       ...
       <book bookLikedBy={bookLikedBy} peeps={peeps} books={books} />
